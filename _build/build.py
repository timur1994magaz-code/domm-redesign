...
VARIANTS = [
    ...
    ("v6", "variant-6-blueprint.html", "Чертёж",
     "Архитектурная подача", "Сетка листа, самоотрисовка линий, подбор дома двумя ползунками",
     "#F4F5F2", "#1B4FD8", "#101418"),
    ("v7", "variant-7-taiga.html", "Тайга",
     "Кинематографичный тёмный лес", "Горизонтальная прокрутка галереи и конфигуратор дома со сметой",
     "#0B120F", "#E0873C", "#E8E4D9"),
    ("v8", "variant-8-pastel.html", "Пастель",
     "Мягкий светлый минимализм", "Шалфейный акцент, плавные пятна и калькулятор с графиком платежей",
     "#FBFAF7", "#4F7059", "#1A211C"),
]
